    ...
    #  if false == (defined(__STD_UTF_16__) && __STD_UTF_16__) // Standard Unicode Text Format (UTF-16)
        typedef struct char16_t { // UTF-16 Character Type
            ...
            public:
                ...
                // [Operator] > ...
                inline char16_t& operator =(char16_t const argument) noexcept { this -> value = argument; return *this; }
                inline char16_t& operator +=(char16_t const argument) noexcept { this -> value += argument; return *this; }
                inline char16_t& operator -=(char16_t const argument) noexcept { this -> value -= argument; return *this; }
                inline char16_t& operator *=(char16_t const argument) noexcept { this -> value *= argument; return *this; }
                inline char16_t& operator /=(char16_t const argument) noexcept { this -> value /= argument; return *this; }
                ...
                inline char16_t& operator &=(char16_t const argument) noexcept { this -> value &= argument; return *this; }
                inline char16_t& operator |=(char16_t const argument) noexcept { this -> value |= argument; return *this; }
                inline char16_t& operator >>=(char16_t const argument) noexcept { return this -> value >>= argument; return *this; }
                inline char16_t& operator <<=(char16_t const argument) noexcept { return this -> value <<= argument; return *this; }
    ...
    #  if false == (defined(__STD_UTF_32__) && __STD_UTF_32__) // Standard Unicode Text Format (UTF-32)
        typedef struct char32_t { // UTF-32 Character Type
            ...
            public:
                ...
                constexpr inline char32_t(unsigned int const argument) : value{argument} {}
                ...
                // [Operator] > ...
                inline char32_t& operator =(char32_t const argument) noexcept { this -> value = argument; return *this; }
                inline char32_t& operator +=(char32_t const argument) noexcept { this -> value += argument; return *this; }
                inline char32_t& operator -=(char32_t const argument) noexcept { this -> value -= argument; return *this; }
                inline char32_t& operator *=(char32_t const argument) noexcept { this -> value *= argument; return *this; }
                inline char32_t& operator /=(char32_t const argument) noexcept { this -> value /= argument; return *this; }
                ...
                inline char32_t& operator &=(char32_t const argument) noexcept { this -> value &= argument; return *this; }
                inline char32_t& operator |=(char32_t const argument) noexcept { this -> value |= argument; return *this; }
                inline char32_t& operator >>=(char32_t const argument) noexcept { return this -> value >>= argument; return *this; }
                inline char32_t& operator <<=(char32_t const argument) noexcept { return this -> value <<= argument; return *this; }
...
#define source_is_cpp false
    ...
    #  define until(expression) while (false == (expression))
    #endif
