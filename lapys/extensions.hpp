...
# define LAPYS_MODULE_EXTENSIONS
  ...
  */
  ...
  # endif
    ...
    # define apply_begin(function, separator, condition, currentArgument, nextArgument, ...) choose(condition(currentArgument, nextArgument, __VA_ARGS__), apply_continue, apply_end)( /* ->> Body of the `apply(...)` loop */ \
      function,                                                                                                                                                                                                                \
    ...
    # if CPP_PREPROCESSOR_FORMAT == CPP_PREPROCESSOR_STANDARD_FORMAT || CPP_COMPILER == CPP_ICC_COMPILER /* ->> No full support planned (ICC is likely *still bugged) */
